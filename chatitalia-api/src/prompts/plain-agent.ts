...
export const buildSystemPrompt = (
    ...
    return [
        ...
        `If the ONLY thing "wrong" with the sentence is writing (case / punctuation / accents), then "errors" MUST be []. FORBIDDEN item example: { "original": "ciao come stai", "correction": "Ciao, come stai?" }.`,
        ``,
